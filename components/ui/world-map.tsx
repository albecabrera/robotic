...
export function WorldMap({ dots = [], lineColor = "#0ea5e9", theme = "light" }: MapProps) {
  ...
  return (
    <div className="relative min-h-[220px] w-full overflow-hidden rounded-lg bg-white font-sans dark:bg-black sm:aspect-[2/1] sm:min-h-0">
      <Image
